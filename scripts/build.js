...
const js = ['js/accounting.js', 'js/export.js', 'js/importer.js', 'js/ops.js', 'js/planning.js', 'js/rules.js', 'js/sync.js', 'js/lock.js', 'js/charts.js', 'js/core.js', 'js/cloud.js', 'js/pages.js'].map(read).join('\n');
